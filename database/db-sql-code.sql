...
CREATE TABLE IF NOT EXISTS public.message (
	mes_id int GENERATED BY DEFAULT AS IDENTITY,
	mes_subject character varying NOT NULL,
	mes_body text NOT NULL,
	mes_created timestamp DEFAULT now() NOT NULL,
	mes_receiver int NOT NULL,
	mes_sender int NOT NULL,
	mes_read boolean DEFAULT false NOT NULL,
	mes_archived boolean DEFAULT false NOT NULL,
	CONSTRAINT message_pkey PRIMARY KEY (mes_id),
	CONSTRAINT to_fkey FOREIGN KEY (mes_receiver)
    REFERENCES public.account (account_id)
    MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE NO ACTION,
	CONSTRAINT from_fkey FOREIGN KEY (mes_sender)
    REFERENCES public.account (account_id)
    MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE NO ACTION
